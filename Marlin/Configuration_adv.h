...
#define HOME_Y_BEFORE_X                     // If G28 contains XY home Y before X, jaideep un - commented
...
//#define LCD_SHOW_E_TOTAL
  ...
  // #define EVENT_GCODE_SD_STOP "G28XY"       // G-code to run on Stop Print (e.g., "G28XY" or "G27"), jaideep, commented, 28-12-2020
  #define EVENT_GCODE_SD_STOP "G28YX"          // G-code to run on Stop Print, first park in y and then x, jaideep, added line, 28-12-2020
  ...
  #define POWER_LOSS_RECOVERY
    ...
    // #define POWER_LOSS_MIN_Z_CHANGE 0.05 // (mm) Minimum Z change before saving power-loss data // jaideep commented because change in position is not desired
  #endif
...
#endif // SDSUPPORT
  // jaideep, adding powerloss recovery
  /* commented, because trying the effect
  #define POWER_LOSS_RECOVERY
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   true // Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
    #define BACKUP_POWER_SUPPLY       // Backup power / UPS to move the steppers on power loss
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  1       // Babysteps are very small. Increase for faster motion., // jaideep, changed from 10 to 1, 28-12-2020
...
//#define POWER_MONITOR_VOLTAGE   // Monitor the system voltage
  ...
  #define POWER_MONITOR_CURRENT_OFFSET -1         // Offset value for current sensors with linear function output, jaideep, added it from shipped printers code, 28-12-2020
...
/*
  ...
  // commented jaideep, 28-12-2020
*/ 
  // added below 2 lines, based on shipped printer's firmware
